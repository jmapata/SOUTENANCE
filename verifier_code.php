    ...
    <div class="login-wrapper">
        ...
        <div class="login-right">
            <div class="welcome-text">
                ...
                <p>Un code à 6 chiffres a été envoyé à <strong><?php echo htmlspecialchars($email); ?></strong>. Il expirera bientôt.</p>
            </div>
            <form action="traitement/verifier_code_traitement.php" method="POST" id="codeForm">
                <input type="hidden" name="email" value="<?php echo htmlspecialchars($email); ?>">
                <div class="form-group">
                    <label for="code">Code de vérification</label>
                    <div class="input-container">
                        <i class="fas fa-key"></i>
                        <input type="text" name="code" id="code" maxlength="6" required autofocus placeholder="Entrez le code reçu">
                    </div>
                </div>
